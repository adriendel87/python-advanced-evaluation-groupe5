...
import notebook_v1 as toolbox1
"""
...
class NotebookLoader:
    ...
    def load(self):
        ...
        """
        return toolbox1.Notebook.from_file(self.filename)
...
class Markdownizer:
    ...
    def markdownize(self):
        ...
        for k in range(len(self.notebook.cells)):
            if isinstance(self.notebook.cells[k], MarkdownCell) == False :
